...
export default function NavBar({ user, token, onLogout }) {
  ...
  const logo = {
    ...
    WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', color: '#FF6B35',
  ...
  const menuLink = {
    ...
    color: '#1A2E38', textDecoration: 'none', fontSize: '15px', fontWeight: 500,
  ...
  const divider = { height: '1px', background: 'rgba(0,78,100,0.10)', margin: '8px 0' };
  ...
  return (
    <>
        ...
        <div style={iconRow}>
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer', padding: '8px', color: '#1A2E38', borderRadius: '10px'
            }}
            aria-label="القائمة"
          >
            <MenuIcon />
      ...
      <div style={mobileMenu} onClick={() => setMenuOpen(false)}>
        ...
        {user && (
          <div style={{
            background: 'rgba(0,78,100,0.05)', borderRadius: '14px',
            ...
            <div>
              <p style={{ margin: 0, fontWeight: 700, color: '#1A2E38', fontSize: '14px' }}>
                {user.username}
              </p>
        ...
        <button
          ...
          style={{
            ...
            color: '#D62246', cursor: 'pointer', width: '100%', textAlign: 'right',
            fontFamily: 'inherit',
          }}
        >
          🚪 تسجيل الخروج
