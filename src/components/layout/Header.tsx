                ...
                {!isMobile && (
                  <div className="mb-6">
                    <div className="inline-block bg-white p-3 rounded-2xl border-2 border-gray-100">
                      <QRCodeSVG value="pi://workpiserv.com" size={140} fgColor="#0F172A" />
                    </div>
                    <p className="text-xs text-muted-foreground mt-2">{t('pimodal.scan')}</p>
                  </div>
                )}
                <div className="space-y-3">
                  <a href={PI_BROWSER_LINKS.android} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full bg-[#0F172A] text-white py-3 px-4 rounded-full font-medium hover:bg-[#0F172A]/90 transition-colors">
