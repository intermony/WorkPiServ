  ...
  return (
    <div className="animate-fade" style={{ background: 'var(--bg-body)', minHeight: '100vh', paddingBottom: '2rem' }}>
      ...
      <div style={{
        ...
        background: 'linear-gradient(145deg, #FFF5F1 0%, #FFF9F0 60%, #F0F8FF 100%)',
  ...
  return (
    <div className="animate-fade" style={{ padding:'0 0 2rem' }}>
      ...
      <div style={{
        ...
        background:'linear-gradient(145deg,#FFF5F1,#FFF0E8)',
        border:'1.5px solid rgba(255,107,53,0.20)', borderRadius:'24px',
