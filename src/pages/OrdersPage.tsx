...
import {
  ...
  Download, MessageCircle, RotateCcw, AlertTriangle
} from 'lucide-react';
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <img
                          src={activeOrder.freelancer.avatar}
                          alt={activeOrder.freelancer.name}
                  ...
                  <div className="relative">
                    {activeOrder.timeline?.map((event, i) => (
                      <div key={i} className="flex gap-4 relative pb-6 last:pb-0">
                        {/* Connector line */}
                        {i < (activeOrder.timeline?.length || 0) - 1 && (
                    ...
                    <div className="mb-4">
                      ...
                      <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${(activeOrder.milestones.filter(m => m.status === 'completed').length / activeOrder.milestones.length) * 100}%`
                          }}
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
                      {activeOrder.milestones.map((m, i) => (
                        <div key={i} className="flex items-center gap-3 py-2">
                          ...
                          <span className={`text-sm ${m.status === 'pending' ? 'text-gray-400' : 'text-gray-700'}`}>
                            {m.title}
                          </span>
