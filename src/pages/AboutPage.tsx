export default function AboutPage() {
  return (
    <div className="section-container py-16 max-w-3xl mx-auto">
      ...
      <p className="text-muted-foreground mb-6">WorkPiServ is the most trustworthy and secure global freelance marketplace powered by Pi Network. We connect talented freelancers with clients worldwide, enabling secure transactions through our smart Escrow system.</p>
