export default function AffiliatePage() {
  return (
    <div className="section-container py-16 max-w-3xl mx-auto text-center">
      ...
      <p className="text-gray-600 mb-8">Earn Pi by referring new users to WorkπServ.</p>
      ...
      <p className="text-gray-500 text-sm">Affiliate program launching soon. Stay tuned!</p>
    </div>
  );
}
