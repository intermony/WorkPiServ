...
export default function AffiliatePage() {
  ...
  return (
    <div className="section-container py-16 max-w-3xl mx-auto">
      ...
      <p className="text-muted-foreground leading-relaxed mb-4">
        Founded in Tunisia, WorkPiServ was built with patience, a belief in the
        project, and a conviction that talented people everywhere deserve a
        fair, borderless way to trade their skills. Every feature here was
        built step by step, with one goal in mind: to be the most trustworthy
        and secure freelance marketplace in the Pi ecosystem — with escrow
        protection, a transparent ledger, and fraud detection built in from
        day one.
      </p>
